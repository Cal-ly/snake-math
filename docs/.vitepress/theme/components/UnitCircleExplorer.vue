<template>
  <div class="unit-circle-explorer">
    <div class="controls">
      <h3>Interactive Unit Circle Explorer</h3>
    ...
    <div class="visualization">
      <canvas ref="circleCanvas" width="600" height="600"></canvas>
    </div>
...
.coordinates, .quadrant-info {
  margin: 1.5rem 0;
}

.coord-display, .quadrant-display {
  margin: 1rem 0;
}

.coord-item, .quadrant-item {
  margin: 0.5rem 0;
  padding: 0.5rem;
  background: white;
  border-radius: 4px;
